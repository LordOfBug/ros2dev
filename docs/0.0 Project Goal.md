...
> **Layer:** 2-3 (Perception & Sensor Fusion) · **Status:** In Progress
...
- [ ] Drive robot through test world and verify live map construction in Foxglove
- [ ] Save the generated map (`ros2 run nav2_map_server map_saver_cli`)
- [ ] Test localization mode: load saved map + switch `slam_toolbox` to `mode: 'localization'`
...
| **3** | 3A | SLAM integration (`slam_toolbox`) | 🟡 In Progress | 2-3 |
