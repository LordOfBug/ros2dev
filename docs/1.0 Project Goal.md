...
> **Single source of truth** for the R550 development journey. This plan merges the original 5-step learning objectives with the [development layers](Roadmap.md) and LLM integration strategy. Each phase maps to specific development layers and cross-references detailed docs.
...
### Key Docs
- Robot model & physics tuning → [Overview.md](Overview.md)
- Nav2 architecture deep dive → [Navigation.md](Navigation.md) Part 1-2
- Package architecture → [Navigation.md](Navigation.md) Part 2.1
...
**Detailed design:** [Navigation.md](Navigation.md) Part 4
...
**Detailed design:** [Navigation.md](Navigation.md) Part 6
...
|-------|----------|-------|
| URDF model & Gazebo physics | [Overview.md](Overview.md) | 1 |
| Nav2 deep dive (5 systems) | [Navigation.md](Navigation.md) Part 1-2 | 1-2 |
| Nav2 package architecture | [Navigation.md](Navigation.md) Part 2.1 | 1-2 |
| TF tree design | [Navigation.md](Navigation.md) Part 3 | 1, 3, 5 |
| Bluetooth anchor integration | [Navigation.md](Navigation.md) Part 4 | 4 |
| LLM mission planner design | [Navigation.md](Navigation.md) Part 6 | 4 |
| Development layers & skills | [Roadmap.md](Roadmap.md) | All |
| LLM integration strategy | [Roadmap.md](Roadmap.md) (per-layer tables) | All |
