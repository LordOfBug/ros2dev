...
> [!NOTE]
> The detailed phase plan with checklists and deliverables lives in [Project Goal.md](Project%20Goal.md). Below is a summary view aligned to the development layers.
...
|-------|-----------|---------------|
| **Project plan & checklists** | [Project Goal.md](Project%20Goal.md) | All |
